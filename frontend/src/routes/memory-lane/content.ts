    ...
    slides: [
      {
        ...
        image: {
          src: blinkTag,
          alt: "A CRT monitor glowing with a blinking <blink> tag, tethered to a phone by a curly modem cord",
        },
      },
      {
        ...
        image: {
          src: animatedGifs,
          alt: "A pixelated stick figure dancing in a loop, surrounded by sparkle stars",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: perlTerminal,
          alt: "A terminal running a Perl shebang line, with a small camel standing on top",
        },
      },
      {
        ...
        image: {
          src: perlBookThinkpad,
          alt: "A towering 900 page Perl book squashing a small ThinkPad laptop, which sprouts a sweat drop",
        },
      },
      {
        ...
        image: {
          src: cableSpeed,
          alt: "A speedometer needle pinned to fast, next to a network cable plug and a small globe",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: phpElephant,
          alt: "A small elephant in a party hat labeled five, beside a blog W icon, a phpBB speech bubble, and a MySQL cylinder",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: jqueryHug,
          alt: "A big friendly dollar sign wrapping its arms around a small DOM element box in a hug",
        },
      },
      {
        ...
        image: {
          ...
          alt: "A leaning under construction sign with a tumbleweed rolling past and a cobweb in the corner",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: quickbooksDesk,
          alt: "A ledger book, a calculator, and a headset stacked on a desk, with a big Q logo watching over them",
        },
      },
      {
        ...
        image: {
          src: wrenchWordpress,
          alt: "A wrench crossed over a WordPress style gear, next to an open toolbox",
        },
      },
      {
        text: "My first integration took place here. WordPress collected data to Intuit QuickBase.",
        image: {
          src: wpQuickbaseIntegration,
          alt: "A box labeled WP connected by a dashed arrow of flowing data particles to a box labeled QB",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: freelanceLaptop,
          alt: "A laptop with gears turning on its screen for backend work, next to a freelancer briefcase",
        },
      },
      {
        ...
        image: {
          src: networkingMiss,
          alt: "Two hands reaching for a handshake but just missing each other, with a question mark speech bubble",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: cloudBlackbird,
          alt: "A soft cloud with a gear inside and a small blackbird perched on top, with a sunrise behind",
        },
      },
      {
        ...
        image: {
          src: cloudGraduation,
          alt: "A cloud wearing a graduation cap, with an admin badge pinned beside it",
        },
      },
      {
        ...
        image: {
          src: integrationNetwork,
          alt: "A web of connected plug nodes labeled REST and SOAP spinning around a clock face",
        },
      },
      {
        text: "I rarely even missed a Salesforce Release Readiness webinar.",
        image: {
          src: releaseReadiness,
          alt: "A calendar beside a webinar screen playing a cloud logo, with a perfect unbroken row of checkmarks",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: workatoPuzzle,
          alt: "Puzzle pieces interlocking around a plug labeled with an API tag",
        },
      },
      {
        ...
        image: {
          src: teamGears,
          alt: "Three interlocking gears of different colors turning smoothly together, with a small thumbs up",
        },
      },
      {
        ...
        image: {
          src: swissArmyToolbox,
          alt: "An open toolbox fanning out a data diamond, a React atom, a Tailwind ribbon, and C# curly braces",
        },
      },
    ],
  },
    ...
    slides: [
      {
        ...
        image: {
          src: compassDoor,
          alt: "A door standing ajar with warm light spilling through, and a compass beside it pointing forward",
        },
      },
      {
        ...
        image: {
          src: sillyPage,
          alt: "A winking browser window with a little heart in its address bar, surrounded by playful confetti",
        },
      },
    ],
  },
